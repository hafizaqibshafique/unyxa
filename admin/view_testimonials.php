...
if(isset($_POST['delete_testimonial']))
{
    ...
    $testimonial_picture = $_POST['testimonial_picture'];    
    $query= "DELETE  FROM `testimonials` WHERE testimonial_id='$testimonial_id' ";
    $result = mysqli_query($conn, $query);
    if($result)
    {
        $image_path  = "images/testimonials/";
        $delete_path = $image_path . '' . $testimonial_picture;
        unlink($delete_path); 
        echo '<script>alert("Testimonials Details Deleted Successfully")</script>'; 
    }
}
 ?>
