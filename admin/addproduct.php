...
if (isset($_POST['submit']))
{
    ...
    $product_sample_tag = mysqli_real_escape_string($conn, $_POST['product_sample_tag']);
    ...
    $query= "INSERT INTO products VALUES ('', '$product_main_id', '$product_sub_id', '$product_title', '$product_code', '$product_old_price', '$product_new_price', '$product_status', '$product_tags', '$product_sale_tag', '$product_new_tag','$product_sample_tag','$product_description','$date','$day');";
                                    ...
                                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                               ...
                                               <!-- Default inline 2-->
                                               <div class="custom-control custom-checkbox custom-control-inline">
                                                 <input value="sample"  name="product_sample_tag" type="checkbox" class="custom-control-input" id="defaultInline3">
                                                 <label class="custom-control-label text-warning" for="defaultInline3">Brand/Sample Product</label>
                                               </div>
