...
if(isset($_POST['submit']))
{
    ...
    $chart_picture = $_POST['chart_picture'];    
    $query= "DELETE  FROM `charts` WHERE chart_id='$chart_id' ";
    $result = mysqli_query($conn, $query);
    if($result)
    {
        $image_path  = "images/charts_categories/";
        $delete_path = $image_path . '' . $chart_picture;
        unlink($delete_path); 
        echo '<script>alert("Chart Details Deleted Successfully")</script>'; 
    }
}
 ?>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card">
                            <div class="card-header  justify-content-between align-items-center">                               
                                <h4 class="card-title">Delete Size Chart</h4> 
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        <thead>
                                            <tr>
                                                <th>Chart Category ID</th>
                                                <th>Category Description</th>
                                                <th>Size Chart id</th>
                                                <th>Size Chart Title</th>
                                                <th>Action</th>
                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                           <?php echo show_size_charts(); ?>
