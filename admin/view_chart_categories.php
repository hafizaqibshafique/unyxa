...
if(isset($_POST['delete_category']))
{
    ...
    $query= "DELETE  FROM `size_chart_categories` WHERE id='$main_category_id' ";
    $result = mysqli_query($conn, $query);
    if($result)
    {
        echo '<script>alert("Size Chart Category Deleted Successfully")</script>'; 
    }
    else
    {
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display table dataTable table-striped table-bordered" >
                                        ...
                                        <tbody>
                                            <?php echo show_chart_categories(); ?>
