...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/single-product-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:55:31 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Single Product Right Sidebar || OurStore</title>
    ...
    <body>
        ...
        <div class="single-page">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="header-top-left">
                                    ...
                                    <div class="welcome-mg singl-pro-sidebar hidden-xs"><span>Default Welcome Message!</span></div>
                                    <!--End-welcome-message-->
                                </div>
                            </div>
                            <!-- Start-Header-links -->
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="header-top-right">
                                    <div class="top-link-wrap">
                                        <div class="single-link singl-pro-sidebar">
            ...
            <div class="signle-heading single-side-heading">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-9 col-sm-8 col-xs-12">
                                    <div class="row">
                                        ...
                                        <!-- Single Product View -->
                                            <div class="single-procuct-view single-sidebar">
                                                ...
                                                <div class="simpleLens-gallery-container" id="p-view">
                                                    <div class="simpleLens-container tab-content">
                                                        ...
                                                        <div class="tab-pane" id="p-view-2">
                                                            <div class="simpleLens-big-image-container">
                                                                <a class="simpleLens-lens-image" data-lens-image="images/single-p/b.jpg">
                                                    ...
                                                    <div class="simpleLens-thumbnails-container text-center">
                                                        <div id="single-product" class="owl-carousel custom-carousel">
                                                            <ul class="nav nav-tabs" role="tablist">
                                                                <li class="active last-li"><a href="#p-view-1" role="tab" data-toggle="tab"><img src="images/single-p/s1.jpg" alt="productd"></a></li>
                                                                <li class="last-li"><a href="#p-view-2" role="tab" data-toggle="tab"><img src="images/single-p/s2.jpg" alt="productd"></a></li>
                                                            </ul>

                                                            <ul class="nav nav-tabs" role="tablist">
                                                                <li class="last-li"><a href="#p-view-3" role="tab" data-toggle="tab"><img src="images/single-p/s3.jpg" alt="productd"></a></li>
                                                                <li class="last-li"><a href="#p-view-4" role="tab" data-toggle="tab"><img src="images/single-p/s4.jpg" alt="productd"></a></li>
                                                            </ul>
                                                            <ul class="nav nav-tabs" role="tablist">
                                                                <li class="last-li"><a href="#p-view-5" role="tab" data-toggle="tab"><img src="images/single-p/s5.jpg" alt="productd"></a></li>
                                                                <li class="last-li"><a href="#p-view-6" role="tab" data-toggle="tab"><img src="images/single-p/s6.jpg" alt="productd"></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="product-details">
                                                <div class="product-content">
                                                    <div class="pro-rating single-p">
                                                        ...
                                                        <div class="rating-links sing-rating sin-left-rat">
                                                            <a href="#">1 Review(s)</a>
                                                ...
                                                <div class="">
                                                    <div class="quick-add-to-cart">
                                                        <form method="post" class="cart">
                                                            ...
                                                            <div class="add-to-cartbest single-add sing-left-add">
                                                ...
                                                <div class="single-pro-cart">
                                                    <div class="add-to-link single-p sing-left-add">
                                    ...
                                    <div class="single-product-description">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="product-description-tab singl-side-des-tab custom-tab">
                                                    <!-- tab bar -->
                                                    <ul class="nav nav-tabs" role="tablist">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 col-sm-5 col-xs-12">
                                                                    <div class="product-rev-left">
                                                                        ...
                                                                        <p>OurStore<span class="posted">(Posted on 20/09/2017)</span></p>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="latest-products-wrap padding-t">
                                        <div class="latest-content text-center">
                                            <div class="section-heading">
                                                <h3><span class="h-color">Upsell</span> Products</h3>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="sing-sidebar-caro-latest indicator">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 sidebar">
                                        ...
                                        <div class="shop-layout">
                                            <div class="layout-list">
                                                <ul>
                                                    ...
                                                    <li><a href="#">Man</a><span>(17)</span></li>
                                                    <li><a href="#">Women</a><span>(14)</span></li>
                                                    <li><a href="#">Accessories</a><span>(11)</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <!-- Shop-Layout-end -->
                                        ...
                                        <div class="price-filter-area shop-layout">
                                            <div class="price-filter">
                                                ...
                                                <p>
                                                  ...
                                                  <input class="sing-side-fil" type="text" style="border:0; color:#f6931f; font-weight:bold;" readonly="" id="amount">
                                                </p>
                                    ...
                                    <div class="shop-banner-area">
                                        <div class="left-sidebar-title">
                                            <h2 class="compare-title contact">Informations</h2>
                                        </div>
                                        <div class="layout-list compare information">
                                            <ul>
                                    ...
                                    <!-- Shop-Layout-start -->
                                    <div class="shop-layout">
                                        <div class="layout-title left-sidebar-title">
                                            <h2 class="compare-title contact">Latest Product</h2>
                                        </div>
                                        <div class="layout-list recent-post latest_product">
                                            <ul>
                                                <!--start-OurStore-post-->
                                                <li>
                                                    <div class="row">
            ...
            <div class="news-letter-wrap text-center">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="footer-contact-info">
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="footer-contact">
                                        ...
                                        <p class="web"><label>email:</label><span class="ft-content web-site"><a href="mailto:admin@infinitelayout.com">admin@infinitelayout.com</a></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
