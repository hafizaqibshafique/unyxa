...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:53:50 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Home Three || OurStore</title>
    ...
    <body>
        ...
        <div class="preloader">
            <div class="loading-center">
                <div class="loading-center-absolute">
                    <div class="object object_one home-3"></div>
                    <div class="object object_two home-3"></div>
                    <div class="object object_three home-3"></div>
                </div>
            </div>
        </div>
        <!--end-Preloader-area-->
        ...
        <div class="page-3">
            <!--Start-Header-area-->
            <header>
                <div class="header-top-wrap home-3">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                                    <div class="header-logo">
                                        <a href="index-2.html"><img src="images/logo/1.png" alt="Mt-Shop"></a>
                                    </div>
                                </div>
                                <!--End-logo-area-->
                                <!--Start-cart-wrap-->
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <ul class="header-cart-wrap home-3">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 hidden-sm hidden-xs">
                                    <div class="log-small"><a class="logo" href="index-2.html"><img alt="Mt-Shop" src="images/logo/s.png"></a></div>
                                    <div class="mainmenu home-3">
                                        <nav>
                                            <ul id="nav">
                                                <li class="angle-down"><a href="index-2.html">Home</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="index-7.html">Homepage Version 6</a></li>
                                                        <li><a href="index-8.html">Homepage Version 7</a></li>
                                                    </ul>
                                                </li>
                                                <li class="angle-down"><a href="shop-grid.html">Bedroom</a>
                                                    <div class="megamenu">
                                                        <div class="megamenu-list">
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Beds</a>
                                                                <a href="shop-grid.html">Platform Beds</a>
                                                                <a href="shop-grid.html">Storage Beds</a>
                                                                <a href="shop-grid.html">Regular Beds</a>
                                                                <a href="shop-grid.html">Sleigh Beds</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Furniture</a>
                                                                <a href="shop-grid.html">Wood</a>
                                                                <a href="shop-grid.html">Sofa</a>
                                                                <a href="shop-grid.html">Mahogany</a>
                                                                <a href="shop-grid.html">Glass</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Nightstands</a>
                                                                <a href="shop-grid.html">Brown Bags</a>
                                                                <a href="shop-grid.html">Distressed</a>
                                                                <a href="shop-grid.html">Cherry</a>
                                                                <a href="#">Weathered</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Headboards</a>
                                                                <a href="shop-grid.html">Upholstered</a>
                                                                <a href="shop-grid.html">Tufted</a>
                                                                <a href="shop-grid.html">Storage</a>
                                                                <a href="shop-grid.html">Padded</a>
                                                            </span>
                                                            <span>
                                                                <a href="shop-grid.html" class="mega-banner">
                                                                    <img src="images/menu/3.jpg" alt="Hi">
                                                                </a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="angle-down"><a href="shop-grid.html">Living room</a>
                                                    <div class="megamenu">
                                                        <div class="megamenu-list">
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Living Chairs</a>
                                                                <a href="#">armchairs</a>
                                                                <a href="shop-grid.html">Living</a>
                                                                <a href="shop-grid.html">mattress</a>
                                                                <a href="shop-grid.html">bunk bed</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Living Tables</a>
                                                                <a href="shop-grid.html">bedspread</a>
                                                                <a href="shop-grid.html">chest</a>
                                                                <a href="shop-grid.html">trunk</a>
                                                                <a href="shop-grid.html">wardrobe</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Ottomans</a>
                                                            ...
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">living storage</a>
                                                            ...
                                                            <span>
                                                                <a href="shop-grid.html" class="mega-banner">
                                                                    <img src="images/menu/4.jpg" alt="Hi">
                                                                </a>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="angle-down"><a href="shop-grid.html">Dining room</a>
                                                    <div class="megamenu home-3">
                                                        <div class="megamenu-list">
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Dining tables</a>
                                                                <a href="shop-grid.html">armchairs</a>
                                                                <a href="shop-grid.html">Living</a>
                                                                <a href="shop-grid.html">mattress</a>
                                                                <a href="shop-grid.html">bunk bed</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Dining sets</a>
                                                                <a href="shop-grid.html">Long Sleeve</a>
                                                                <a href="shop-grid.html">Short Sleeve</a>
                                                                <a href="shop-grid.html">Polo Short Sleeve</a>
                                                                <a href="shop-grid.html">Heeled sandals</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Dining chairs</a>
                                                                <a href="shop-grid.html">hoodies</a>
                                                                <a href="shop-grid.html">Ankle</a>
                                                                <a href="shop-grid.html">SFootwear</a>
                                                                <a href="shop-grid.html">Wedges</a>
                                                            </span>
                                                            <span class="mega-single">

                                                                <a href="shop-grid.html" class="mega-title">Dining storage</a>
                                                                <a href="shop-grid.html">Earrings</a>
                                                                <a href="shop-grid.html">Braclets</a>
                                                                <a href="shop-grid.html">Nosepins</a>
                                                                <a href="shop-grid.html">Bangels</a>
                                                            ...
                                                            <span>
                                                                <a href="shop-grid.html" class="mega-banner">
                                                                    <img src="images/menu/5.jpg" alt="Hi">
                                                                </a>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <div class="mobile-menu">
                                    <nav id="dropdown">
                                        <ul>
                                            ...
                                            <li><a href="shop-grid.html">Bedroom</a>
                                                <ul>
                                                    <li><a href="shop-grid.html">Beds</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Platform Beds</a></li>
                                                            <li><a href="shop-grid.html">Storage Beds</a></li>
                                                            <li><a href="shop-grid.html">Regular Beds</a></li>
                                                            <li><a href="shop-grid.html">Sleigh Beds</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Furniture</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Wood</a></li>
                                                            <li><a href="shop-grid.html">Sofa</a></li>
                                                            <li><a href="shop-grid.html">Mahogany</a></li>
                                                            <li><a href="shop-grid.html">Glass</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Nightstands</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Brown Bags</a></li>
                                                            <li><a href="shop-grid.html">Distressed</a></li>
                                                            <li><a href="shop-grid.html">Cherry</a></li>
                                                            <li><a href="shop-grid.html">Weathered</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Headboards</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Upholstered</a></li>
                                                            <li><a href="shop-grid.html">Tufted
        </a></li>
                                                            <li><a href="shop-grid.html">Storage</a></li>
                                                            <li><a href="shop-grid.html">Padded</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="shop-grid.html">Living room</a>
                                                <ul>
                                                    <li><a href="shop-grid.html">Living Chairs</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">armchairs</a></li>
                                                            <li><a href="shop-grid.html">Living</a></li>
                                                            <li><a href="shop-grid.html">mattress</a></li>
                                                            <li><a href="shop-grid.html">bunk bed</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Living Tables</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">bedspread</a></li>
                                                            <li><a href="shop-grid.html">chest</a></li>
                                                            <li><a href="shop-grid.html">trunk</a></li>
                                                            <li><a href="shop-grid.html">wardrobe</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Ottomans</a>
                                                        <ul>
                                                    ...
                                                    <li><a href="shop-grid.html">living storage</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Earrings</a></li>
                                                            <li><a href="shop-grid.html">Braclets
        </a></li>
                                                            <li><a href="shop-grid.html">Nosepins</a></li>
                                                            <li><a href="shop-grid.html">Bangels</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="shop-grid.html">Dining room</a>
                                                <ul>
                                                    <li><a href="shop-grid.html">Dining Chairs</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">armchairs</a></li>
                                                            <li><a href="shop-grid.html">Living</a></li>
                                                            <li><a href="shop-grid.html">mattress</a></li>
                                                    ...
                                                    <li><a href="shop-grid.html">Dining sets</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Long Sleeve</a></li>
                                                            <li><a href="shop-grid.html">Short Sleeve</a></li>
                                                            <li><a href="shop-grid.html">Polo Short Sleeve</a></li>
                                                            <li><a href="shop-grid.html">Heeled sandals</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Dining chairs</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">hoodies</a></li>
                                                            <li><a href="shop-grid.html">Ankle</a></li>
                                                            <li><a href="shop-grid.html">SFootwear</a></li>
                                                            <li><a href="shop-grid.html">Wedges</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Dining storage</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Earrings</a></li>
                                                            <li><a href="shop-grid.html">Braclets
        </a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 text-right">
                                    <div class="slider-content home-3">
                                        <!-- layer 1 -->
                                        <div class="layer-1-1">
                                            <h2 class="title1 wow bounceInLeft" data-wow-duration="0.5s" data-wow-delay=".8s">Style for <span class="h-color">Home</span></h2>
                                        </div>
                                        <!-- layer 2 -->
                                        <div class="layer-1-2">
                                            <p class="title2">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 text-left">
                                    <div class="slider-content home-3">
                                        <!-- layer 1 -->
                                        <div class="layer-1-1">
                                            <h2 class="title1 wow bounceInRight" data-wow-duration="0.5s" data-wow-delay=".8s">Latest <span class="h-color">armchair</span></h2>
                                        </div>
                                        <!-- layer 2 -->
                                        <div class="layer-1-2">
                                            <p class="title2">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 banner-r-b">
                            <div class="banner-img">
                                <div class="single-banner home-3 wow bounceInLeft" data-wow-duration="0.1s" data-wow-delay="0.1s">
                                    <a href="#"><img alt="Hi Guys" src="images/banner/8.jpg" /></a>
                                </div>
                                <div class="single-ban-content">
                                    <h4 class="hidden-sm hidden-xs">add something</h4>
                                    <p class="hidden-sm hidden-xs">best modern furniture for your home.</p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="banner-img">
                                <div class="single-banner home-3 wow bounceInRight" data-wow-duration="0.1s" data-wow-delay="0.1s">
                                    <a href="#"><img alt="Hi Guys" src="images/banner/9.jpg" /></a>
                                </div>
                                <div class="single-ban-content">
                                    <h4 class="hidden-sm hidden-xs">Beautify</h4>
                                    <p class="hidden-sm hidden-xs">all accessories collection.</p>
                    ...
                    <div class="row">
                        <div class="featured-carousel indicator">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    <div class="product-img-wrap">
                                        <a class="product-img" href="#"><img src="images/product/c1.jpg" alt="product-image" /></a>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Chair Styles</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    <div class="product-img-wrap">
                                        <a class="product-img" href="#"> <img src="images/product/c2.jpg" alt="product-image" /></a>
                                        <div class="add-to-cart">
                                            <a href="#" title="add to cart">
                                                <div><span>View More</span></div>
                                            </a>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Sofa Collection</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    <div class="product-img-wrap">
                                        <a class="product-img" href="#"> <img src="images/product/c3.jpg" alt="product-image" /></a>
                                        <div class="add-to-cart">
                                            <a href="#" title="add to cart">
                                                <div><span>View More</span></div>
                                            </a>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Decoration</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="new">new</div>
                                    <div class="product-img-wrap">
                                        <a class="product-img" href="#"> <img src="images/product/c4.jpg" alt="product-image" /></a>
                                        <div class="add-to-cart">
                                            <a href="#" title="add to cart">
                                                <div><span>View More</span></div>
                                            </a>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Desk Edition</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    <div class="product-img-wrap">
                                        <a class="product-img" href="#"> <img src="images/product/c5.jpg" alt="product-image" /></a>
                                        <div class="add-to-cart">
                                            <a href="#" title="add to cart">
                                                <div><span>View More</span></div>
                                            </a>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Door Edition</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    <div class="product-img-wrap">
                                        <a class="product-img" href="#"> <img src="images/product/c6.jpg" alt="product-image" /></a>
                                        <div class="add-to-cart">
                                            <a href="#" title="add to cart">
                                                <div><span>View More</span></div>
                                            </a>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Armchair</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    <div class="product-img-wrap">
                                        <a class="product-img" href="#"> <img src="images/product/c7.jpg" alt="product-image" /></a>
                                        <div class="add-to-cart">
                                            <a href="#" title="add to cart">
                                                <div><span>View More</span></div>
                                            </a>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Almirah</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="features-tab">
                              <!-- Nav tabs -->
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Chairs</a></li>
                                    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Sofas</a></li>
                                    <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Beds</a></li>
                                    <li role="presentation"><a href="#section" aria-controls="messages" role="tab" data-toggle="tab">Decoration</a></li>
                                </ul>
                                <!-- Tab panes -->
                                        ...
                                        <div class="row">
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/17.jpg" alt="product-image" /></a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/18.jpg" alt="product-image" /></a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/19.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/20.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/21.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/22.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                        ...
                                        <div class="row">
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/23.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/24.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/25.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            <div class="single-banner banner-r-b">
                                <a href="#"><img alt="Hi Guys" src="images/banner/10.jpg" /></a>
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                            <div class="single-banner">
                                <a href="#"><img alt="Hi Guys" src="images/banner/11.jpg" /></a>
                            </div>
                        </div>
                    </div>
                </div>
           ...
           <!--Start-new-products-wrap-->
            <div class="latest-products-wrap home-3 padding-t">
                <div class="container">
                    <div class="latest-content text-center">
                        <div class="section-heading">
                            <h3><span class="h-color">New</span> Products</h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="featured-carousel indicator">
                       ...
                       <!--Satar-single-p-wrap-->
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="single-p-wrap home-3  banner-r-b text-center">
                                ...
                                <h4>Free shipping on all <br> USA order.</h4>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="single-p-wrap home-3  banner-r-b text-center">
                                ...
                                <h4>Money Guaranty 15 days money back guaranty !</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, veniam.</p>
                            </div>
                        </div>
                        <!--end-single-p-wrap-->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="single-p-wrap home-3 text-center">
                                ...
                                <h4>Store Hours Open: 8:00AM - Close: 20:00PM.</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et, veniam.</p>
                            </div>
                        </div>
                        <!--end-single-p-wrap-->
            ...
            <footer class="footer-area">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                <div class="footer-logo home-3">
                                    <a href="index-2.html"><img src="images/logo/1.png" alt="Logo Demo"></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <h3 class="wedget-title">Who we are</h3>
                                <!--footer-text-start-->
                                <div class="footer-top-content">
                                    <p class="des home-3">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it.</p>
                ...
                <div class="footer-bottom-area">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                <div class="copy-right-home-3 text-center">
                                    <span> Copyright &copy; 2017 <a href="#">infinitelayout</a>. All Rights Reserved.</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:54:06 GMT -->
</html>