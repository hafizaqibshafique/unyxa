...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:54:50 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Home Seven || OurStore</title>
    ...
    <body>
        ...
        <!--<div class="preloader">
            <div class="loading-center">
                <div class="loading-center-absolute">
                    <div class="object object_one home-2"></div>
                    <div class="object object_two home-2"></div>
                    <div class="object object_three home-2"></div>
                </div>
            </div>
        </div>-->
        <!--end-Preloader-area-->
        ...
        <div class="page-2 page-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div id="search-category-wrap">
                                        <form class="header-search-box home-7" action="#" method="post">
            ...
            <section class="slider-area home-1 home-7">
                <div class="preview-1 home-3 home-7">
                    <div id="ensign-nivoslider" class="slides">
                        <img src="images/slider/13.jpg" alt="" title="#slider-direction-1" />
                        <img src="images/slider/14.jpg" alt="" title="#slider-direction-2" />
                    </div>
                    <!-- direction 1 -->
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 text-right">
                                    <div class="slider-content home-7">
                                        <!-- layer 1 -->
                                        <div class="layer-1-1">
                                            <h2 class="title1 wow bounceInLeft" data-wow-duration="0.5s" data-wow-delay=".8s">Kitchen <span class="h-color">appliances</span></h2>
                                        </div>
                                        <!-- layer 2 -->
                                        <div class="layer-1-2">
                                            <p class="title2">
                                        ...
                                        <div class="layer-1-3 hidden-xs">
                                            <p class="title3 wow bounceInLeft" data-wow-duration="0.5s" data-wow-delay="1.5s" >Last chance to buy extra 50% off just for you.</p>
                                        </div>
                                        <!-- layer 4 -->
                                        <div class="layer-1-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 text-left">
                                    <div class="slider-content home-7">
                                        <!-- layer 1 -->
                                        <div class="layer-1-1">
                                            <h2 class="title1 wow bounceInRight" data-wow-duration="0.5s" data-wow-delay=".8s">Latest <span class="h-color">Appliances</span></h2>
                                        </div>
                                        <!-- layer 2 -->
                                        <div class="layer-1-2">
                                            <p class="title2">
                    ...
                    <div class="row">
                       <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="single-banner banner-r-b four">
                                <a href="#"><img alt="Hi Guys" src="images/banner/32.jpg" /></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="single-banner">
                                <a href="#"><img alt="Hi Guys" src="images/banner/33.jpg" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="features-tab">
                              <!-- Nav tabs -->
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="#section" aria-controls="messages" role="tab" data-toggle="tab">Best Offer</a></li>
                                </ul>
                                <!-- Tab panes -->
                                            ...
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/62.jpg" alt="product-image" /></a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/63.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/65.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/66.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/59.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/61.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                        ...
                                        <div class="row">
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/60.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/64.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                            <div class="single-banner banner-r-b">
                                <a href="#"><img alt="Hi Guys" src="images/banner/35.jpg" /></a>
                            </div>
                        </div>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            <div class="single-banner">
                                <a href="#"><img alt="Hi Guys" src="images/banner/34.jpg" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="business-policy-wrap home-2 home-7">
                <div class="container">
                           ...
                           <!--Satar-single-p-wrap-->
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="single-p-wrap banner-r-b text-center">
                                    <span class="busines-icon pull-left"><i class="fa fa-plane"></i></span>
                                    <h4 class="media-body">FREE SHIPPING. <br><span class="business-para">On order over $500.00</span></h4>
                                </div>
                            </div>
                            <!--end-single-p-wrap-->
                            <!--Satar-single-p-wrap-->
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="single-p-wrap banner-r-b text-center">
                                    <span class="busines-icon pull-left"><i class="fa fa-life-ring"></i></span>
                                    <h4 class="media-body">SUPPORT 24/7. <br><span class="business-para">Hotline 0123 456 789</span></h4>
                                </div>
                            </div>
                            <!--end-single-p-wrap-->
                            <!--Satar-single-p-wrap-->
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="single-p-wrap banner-r-b text-center">
                                    <span class="busines-icon pull-left"><i class="fa fa-money"></i></span>
                                    <h4 class="media-body">FREE RETURN. <br><span class="business-para">Free 90 days return</span></h4>
                                </div>
                            </div>
                            <!--end-single-p-wrap-->
                            <!--Satar-single-p-wrap-->
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="single-p-wrap text-center">
                                    <span class="busines-icon pull-left"><i class="fa fa-clock-o"></i></span>
                                    <h4 class="media-body">OPEN: 8:00AM - CLOSE: 20:00PM.</h4>
                                </div>
                            </div>
                            <!--end-single-p-wrap-->
                        </div>
            ...
            <div class="news-letter-wrap text-center home-2 home-7">
                <div class="container">
                    <div class="row">
            ...
            <footer class="footer-area">
                <div class="footer-top-area home-2 home-7">
                    <div class="container">
                        <div class="row">
                ...
                <div class="footer-bottom-area home-2 home-7">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:55:08 GMT -->
</html>