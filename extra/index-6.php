...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:54:22 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Home Five || OurStore</title>
    ...
    <body>
        ...
        <div class="preloader">
            <div class="loading-center">
                <div class="loading-center-absolute">
                    <div class="object object_one home-5"></div>
                    <div class="object object_two home-5"></div>
                    <div class="object object_three home-5"></div>
                </div>
            </div>
        </div>
        <!--end-Preloader-area-->
        ...
        <div class="page-5">
            <!--Start-Header-area-->
            <header>
                <div class="header-top-wrap home-5">
                    <div class="container">
                        <div class="row">
                ...
                <div class="header-mid-wrap home-5">
                    <div class="container">
                        <div class="header-mid-content">
                            <div class="row">
                                <!--Start-logo-area-->
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="header-logo home-5">
                                    ...
                                    <div class="mainmenu home-5">
                                        <nav>
                                            <ul id="nav">
                                                ...
                                                <li class="angle-down"><a href="shop-grid.html">Jewellery</a>
                                                    <div class="megamenu home-3">
                                                        <div class="megamenu-list">
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Women's</a>
                                                                <a href="shop-grid.html">Earrings</a>
                                                                <a href="shop-grid.html">Rings</a>
                                                                <a href="shop-grid.html">Bracelets</a>
                                                                <a href="shop-grid.html">Pendants</a>
                                                                <a href="#">New Collections</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Men's</a>
                                                                <a href="shop-grid.html">neckwear</a>
                                                                <a href="shop-grid.html">Rings</a>
                                                                <a href="shop-grid.html">Bracelets</a>
                                                                <a href="shop-grid.html">Wrist wear</a>
                                                                <a href="shop-grid.html"> New Collections</a>
                                                            </span>
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Jewell:Fashion's</a>
                                                                <a href="shop-grid.html">necklace</a>
                                                                <a href="shop-grid.html">Earrings</a>
                                                                <a href="shop-grid.html">Rings</a>
                                                                <a href="shop-grid.html">Bracelets</a>
                                                            ...
                                                            <span class="mega-single">
                                                                <a href="shop-grid.html" class="mega-title">Designer</a>
                                                                <a href="shop-grid.html">Ciana</a>
                                                                <a href="shop-grid.html">Russia</a>
                                                                <a href="shop-grid.html">Arsya</a>
                                                                <a href="shop-grid.html">bandi</a>
                                                                <a href="shop-grid.html">janko</a>
                                                            </span>
                                                            <span>
                                                                <a href="shop-grid.html" class="mega-banner">
                                                                    <img src="images/menu/7.jpg" alt="Hi">
                                                                </a>
                                                            </span>
                                                        </div>
                                                    </div>
                                ...
                                <div class="mobile-menu">
                                    <nav id="dropdown">
                                        <ul>
                                            ...
                                            <li><a href="shop-grid.html">Jewellery</a>
                                                <ul>
                                                    <li><a href="shop-grid.html">Women's</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Earrings</a></li>
                                                            <li><a href="shop-grid.html">Rings</a></li>
                                                            <li><a href="shop-grid.html">Bracelets</a></li>
                                                            <li><a href="shop-grid.html">Pendants</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Men's</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Neckwear</a></li>
                                                            <li><a href="shop-grid.html">Rings</a></li>
                                                            <li><a href="shop-grid.html">Bracelets</a></li>
                                                            <li><a href="shop-grid.html">wist wear</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Jewell:Fashion's</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">necklace</a></li>
                                                            <li><a href="shop-grid.html">Bracelets</a></li>
                                                            <li><a href="shop-grid.html">Earrigns</a></li>
                                                            <li><a href="shop-grid.html">Rings</a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="shop-grid.html">Designer</a>
                                                        <ul>
                                                            <li><a href="shop-grid.html">Ciana</a></li>
                                                            <li><a href="shop-grid.html">Russia
        </a></li>
                                                            <li><a href="shop-grid.html">Arsya</a></li>
                                                            <li><a href="shop-grid.html">bandi</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
            ...
            <!--End-Header-area-->
            <!-- Start-slider-->
            <section class="slider-area home-1 home-2 home-5">
                <div class="container">
                    <div class="row">
                        <!--start-slider-side-banner-->
                        <div class="col-lg-4 col-md-4 hidden-sm hidden-xs">
                            <div class="single-banner">
                                <a href="#"><img alt="Hi Bro." src="images/banner/19.jpg" /></a>
                            </div>
                        </div>
                        <!--end-slider-side-banner-->
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                            <div class="preview-1 home-5">
                                <div id="ensign-nivoslider" class="slides">
                                    <img src="images/slider/9.jpg" alt="" title="#slider-direction-1" />
                                    <img src="images/slider/10.jpg" alt="" title="#slider-direction-2" />
                                </div>
                                <!-- direction 1 -->
            ...
            <!-- End-slider-->
            <!-- Start-banner-area-->
            <div class="banner-area padding-t home-5">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="single-banner banner-r-b">
                                <a href="#"><img alt="Hi Guys" src="images/banner/20.jpg" /></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="single-banner banner-r-b">
                                <a href="#"><img alt="Hi Guys" src="images/banner/21.jpg" /></a>
                            </div>
                        </div>
                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="single-banner">
                                <a href="#"><img alt="Hi Guys" src="images/banner/22.jpg" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- End-banner-area-->
            <!-- Start-featured-area-->
            <div class="featured-product-wrap home-5 padding-t">
                <div class="container">
                            ...
                            <div class="features-tab">
                              <!-- Nav tabs -->
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Necklace</a></li>
                                    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Earrings</a></li>
                                    <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Bracelet</a></li>
                                    <li role="presentation"><a href="#section" aria-controls="messages" role="tab" data-toggle="tab">Ring</a></li>
                                </ul>
                                <!-- Tab panes -->
                                            ...
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/42.jpg" alt="product-image" /></a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/37.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/39.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/40.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/41.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/43.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                        ...
                                        <div class="row">
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/36.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                        ...
                                        <div class="row">
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/38.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
            ...
            <div class="business-policy-wrap home-5">
                <div class="container">
            ...
            <div class="latest-products-wrap home-5 padding-t">
                <div class="container">
            ...
            <!--Start-banner-area-->
            <div class="banner-area padding-t home-5 banner-dis">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="single-banner fullwide-ban">
                                <a href="#"><img alt="Hi Guys" src="images/banner/24.jpg" /></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="featured-carousel indicator">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Necklace</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Earrings</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Bracelet</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="new">new</div>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Gold Ring</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="sale-border"></div>
                                    ...
                                    <div class="product-info text-center">
                                        <div class="product-content">
                                            <a href="#"><h3 class="pro-name">Silver Ring</h3></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!--Start-blog-area-->
            <div class="latest-blog-wrap home-5 padding-t">
                <div class="container">
            ...
            <div class="variety-products-wrap home-5 padding-t">
                <div class="container">
                    <div class="row">
            ...
            <div class="news-letter-wrap text-center home-5">
                <div class="container">
                    <div class="row">
            ...
            <footer class="footer-area">
                <div class="footer-top-area home-5">
                    <div class="container">
                        <div class="row">
                ...
                <div class="footer-bottom-area home-5">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="modal-product">
                                ...
                                <div class="product-images">
                                    <div class="main-image images">
                                        <img alt="" src="images/product/31.jpg">
                                    </div>
                                </div>
                                <!-- product-images -->
                                <!-- product-info -->
...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:54:36 GMT -->
</html>