...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:53:49 GMT -->
<head>
        <meta charset="utf-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="header-logo">
                                        <a href="index-2.html"><img src="images/logo/1.png" alt="OurStore"></a>
                                    </div>
                                </div>
                                <!--End-logo-area-->
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 hidden-sm hidden-xs">
                                    <div class="log-small"><a class="logo" href="index-2.html"><img alt="OurStore" src="images/logo/s.png"></a></div>
                                    <div class="mainmenu">
                                        <nav>
                                            <ul id="nav">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="single-banner fullwide-ban">
                                <a href="#"><img alt="Hi Guys" src="images/banner/23.jpg" /></a>
                            </div>
                        </div>
                    </div>
                </div>
