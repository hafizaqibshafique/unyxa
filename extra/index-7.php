...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:54:36 GMT -->
<head>
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>Home Six || OurStore</title>
    ...
    <body>
        ...
        <!--header-area-start-->
        <!--Start-main-wrapper-->
        <div class="page-2 page-6">
            <!--Start-Header-area-->
            <header>
                <div class="header-top-wrap home-2 home-6">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="header-top-left">
                                    ...
                                    <div class="dropdown top-language-wrap"> <a role="button" data-toggle="dropdown" data-target="#" class="top-language dropdown-toggle" href="#"> English <span class="caret"></span> </a>
                                        <ul class="dropdown-menu" role="menu">
                                            <li role="presentation"><a role="menuitem" href="#">English </a></li>
                                            <li role="presentation"><a role="menuitem" href="#">French </a></li>
                                            <li role="presentation"><a role="menuitem" href="#">German </a></li>
                                        </ul>
                                    </div>
                                    <!--End-Header-language-->
                                    <!--Start-Header-currency-->
                                    <div class="dropdown top-currency-wrap"> <a role="button" data-toggle="dropdown" data-target="#" class="top-currency dropdown-toggle" href="#"> USD <span class="caret"></span></a>
                                        <ul class="dropdown-menu" role="menu">
                                    ...
                                    <div class="welcome-mg hidden-xs"><span>Welcome to OurStore!</span></div>
                                    <!--End-welcome-message-->
                                </div>
                            </div>
                            <!-- Start-Header-links -->
                ...
                <div class="header-mid-wrap home-2 home-6">
                    <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div id="search-category-wrap">
                                        <form class="header-search-box home-6" action="#" method="post">
              ...
              <div class="mainmenu-area home-2 home-6 hidden-sm hidden-xs">
                                        ...
                                        <nav>
                                            <ul id="nav">
                                                ...
                                                <li class="angle-down"><a href="shop-grid.html">Men</a>
                                                    <div class="megamenu home-2 home-6">
                ...
                <div class="mobile-menu-area home-6 visible-sm visible-xs">
                    <div class="container">
                        <div class="row">
            ...
            <!--End-Header-area-->
            <!-- Start-slider-->
            <section class="slider-area home-1 home-2 home-6">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="category-main-wrap home-6 hidden-sm hidden-xs">
                                <div class="category-title"><h3>Category</h3></div>
                                    <div class="cat-single-wrap">
                                        <ul class="nav">
                                            <li>
                                            <a href="#">Special Goods</a>
                                            <div class="single-wrap">
                                                <div class="cat-wrap">
                                                    ...
                                                    <br>
                                                    <a class="hidden-sm hidden-xs" href="#"><img alt="" src="images/banner/25.jpg" class="img-responsive"></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#">Furniture</a>
                                            <div class="single-wrap smart-phone">
                                                <div class="cat-wrap">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <h3>brand</h3>
                                        ...
                                        <li class="cat-none"><a href="#">Illumination</a></li>
                                        <li class="cat-none"><a href="#">Every Day</a></li>
                                        <li class="more-view"><a href="#">Bestseller</a></li>
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                            <div class="preview-1 home-2 home-6">
                                <div id="ensign-nivoslider" class="slides">
                                    <img src="images/slider/11.jpg" alt="" title="#slider-direction-1" />
                                    <img src="images/slider/12.jpg" alt="" title="#slider-direction-2" />
                                </div>
                                <!-- direction 1 -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 text-right">
                                                <div class="slider-content three">
                                                    <!-- layer 1 -->
                                                    <div class="layer-1-1"><h2 class="title1 wow bounceInLeft" data-wow-duration="0.5s" data-wow-delay=".8s">Best Handmade <span class="h-color">Goods</span></h2>
                                                    </div>
                                                    <!-- layer 2 -->
                                                    <div class="layer-1-2">
                                                        <p class="title2">
            ...
            <!-- End-slider-->
            <!-- Start-banner-area-->
            <div class="banner-area padding-t home-2 home-6">
                <div class="container">
                    <div class="row">
                       <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <div class="single-banner banner-r-b four">
                                <a href="#"><img alt="Hi Guys" src="images/banner/27.jpg" /></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="single-banner banner-m-b">
                                <a href="#"><img alt="Hi Guys" src="images/banner/28.jpg" /></a>
                            </div>
                            <div class="single-banner">
                                <a href="#"><img alt="Hi Guys" src="images/banner/29.jpg" /></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- End-banner-area-->
             <!-- Start-featured-area-->
            <div class="featured-product-wrap home-2 home-6 padding-t">
                <div class="container">
                            ...
                            <div class="features-tab">
                              <!-- Nav tabs -->
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Knitting</a></li>
                                    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Home &amp; Living</a></li>
                                    <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Kitchen</a></li>
                                    <li role="presentation"><a href="#section" aria-controls="messages" role="tab" data-toggle="tab">Kids Toys</a></li>
                                </ul>
                                <!-- Tab panes -->
                                            ...
                                            <div class="featured-carousel indicator">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/56.jpg" alt="product-image" /></a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/54.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="new">Sale</div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/55.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="sale-border"></div>
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/57.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="single-product">
                                                        <div class="product-img-wrap">
                                                            <a class="product-img" href="#"> <img src="images/product/58.jpg" alt="product-image" /></a>
                                                            <div class="add-to-link">
                                                                <a href="#">
                                                                    <div><i class="fa fa-heart"></i><span>Add to Wishlist</span></div>
                                                                </a>
            ...
            <div class="latest-trend-wrap padding-t home-2 home-6">
            ...
            <div class="latest-products-wrap home-2 home-6 padding-t">
                <div class="container">
            ...
            <div class="clear"></div>
            <!-- Start-banner-area-->
            <div class="banner-area padding-t home-3 home-6">
                <div class="container">
                    <div class="row">
                        <!--start-single-banner-->
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 banner-r-b">
                            <div class="banner-img">
                                <div class="single-banner home-3 wow bounceInLeft" data-wow-duration="0.1s" data-wow-delay="0.1s">
                                    <a href="#"><img alt="Hi Guys" src="images/banner/30.jpg" /></a>
                                </div>
                                <div class="single-ban-content">
                                    <h4 class="hidden-sm hidden-xs">add something</h4>
                                    <p class="hidden-sm hidden-xs">best modern women wing.</p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="banner-img">
                                <div class="single-banner home-3 wow bounceInRight" data-wow-duration="0.1s" data-wow-delay="0.1s">
                                    <a href="#"><img alt="Hi Guys" src="images/banner/31.jpg" /></a>
                                </div>
                                <div class="single-ban-content">
            ...
            <div class="latest-testimonial-wrap home-2 home-6">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                            ...
                            <div class="testimonial-heading home-2">
                                <div class="section-heading">
                                    <h3><span class="h-color">Latest</span> Reviews</h3>
                                </div>
                            </div>
            ...
            <!--Start-blog-area-->
            <div class="latest-blog-wrap padding-t home-2 home-6">
                <div class="container">
            ...
            <!--End-blog-area-->
            <!--Start-brand-area-->
            <div class="brands-area home-2 home-6">
                <div class="container">
                    <!--barand-heading-->
            ...
            <div class="variety-products-wrap home-2 home-6 padding-t">
                <div class="container">
                    <div class="row">
            ...
            <div class="news-letter-wrap text-center home-2 home-6">
                <div class="container">
                    <div class="row">
            ...
            <footer class="footer-area">
                <div class="footer-top-area home-2 home-6">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                ...
                <div class="footer-bottom-area home-2 home-6">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<!-- Mirrored from ourstore.infinitelayout.com/ourstore/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Aug 2020 13:54:50 GMT -->
</html>