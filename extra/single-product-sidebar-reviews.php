                                                ...
                                                <div class="simpleLens-gallery-container" id="p-view">
                                                    <div class="simpleLens-container tab-content">
                                                        ...
                                                        <div class="tab-pane" id="p-view-2">
                                                            <div class="simpleLens-big-image-container">
                                                                <a class="simpleLens-lens-image" data-lens-image="images/single-p/b.html">
                                                ...
                                                <div class="">
                                                    <div class="quick-add-to-cart">
                                                        <form method="post" class="cart">
                                                            ...
                                                            <div class="add-to-cartbest single-add add-to-cartbest single-add sing-left-add">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="product-description-tab singl-side-des-tab custom-tab">
                                                    <!-- tab bar -->
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li><a href="#product-des" data-toggle="tab">Product Description</a></li>
                                                        <li class="active"><a href="#product-rev" data-toggle="tab">Reviews</a></li>
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="product-tag">
                                                            ...
                                                            <p class="product-action">
                                                                <a href="http://infinitelayout.com/">Laptop </a> <span>(1)</span>
                                                            </p>
